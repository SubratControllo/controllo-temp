export const brandAssets = Object.freeze({
  ...
  googleWorkspace: { src: '/assets/brands/google-workspace.svg', format: 'wordmark' },
  jira: { src: '/assets/brands/jira.svg', format: 'mark' },
  confluence: { src: '/assets/brands/confluence.svg', format: 'mark' },
});
